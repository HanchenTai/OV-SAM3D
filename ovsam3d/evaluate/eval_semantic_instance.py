...
def evaluate_matches(matches):
    ...
    for scene_name in gt_category_names.keys():
        pcdc_scores.append(np.asarray([len(matched_predictions_category_names[d_inf][oid][scene_name]) / len(gt_category_names[scene_name]) for oid in
                                       matched_predictions_category_names[d_inf].keys()]))
